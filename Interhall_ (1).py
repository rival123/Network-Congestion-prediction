...
model10 = XGBClassifier(booster='gbtree', colsample_bylevel=1,
       colsample_bytree=0.7, gamma=0, learning_rate=0.025, max_delta_step=0,
       max_depth=5, min_child_weight=11, missing=-999, n_estimators=1500,
...
estimators = [('LR',model1), ('KNN',model2), ('SVC',model3),
              ...
              ('NB',model7), ('RF',model8),  ('ET',model9), ('XGBC',model10)]
...
print('Accuracy on test:',(y_test == y_pred).mean())
